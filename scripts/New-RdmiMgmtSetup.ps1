...
try
{
    ...
    PowerShell -NoProfile -ExecutionPolicy Bypass -Command "& '$CodeBitPath\RemoveRG.ps1' -SubscriptionId $SubscriptionId -UserName $UserName -Password $Password -ResourceGroupName $ResourceGroupName"
